...
public class Exponent implements Computer {
    ...
    @Override
    public ComputationTask resolveTask(ComputationTask task) throws TaskMismatchException, InterruptedException {
        ...
        task.setResult(Math.pow(x, y));
        return task;
    }

    @Override
    public ComputationType getComputerType() {
        return ComputationType.EXPONENT;
    }
}
